function TalentPoolReminderEmail(emailRecipients){
    ...
    var getEmailBody = function (){
        ...
        body += "                        <span style=\"font-family:'Raleway',sans-serif;color:#666;font-size:15px;text-align:left; padding:0px 30px; display:block;\">";
        body += "                          Hi, since you are now on the Talent Pool we would like to ask you that during this time you upload your CV into Glow, please use the attached template to do it. In order to upload it, go to <a href='https:\/\/glow.corp.globant.com\/'>Glow<\/a>.";
        body += "                    <\/span>";
        body += "                    <\/td>";
        body += "                <\/tr>";
        body += "                <tr bgcolor=\"#fff\">";
        ...
        body += "                      <span style=\"font-family:'Raleway',sans-serif;font-weight:700;color:#666;font-size:16px;text-align:left\">";
        body += "                        Go to My Information ";
        body += "                      <\/span>";
        body += "                      <br>";
        body += "                      <span style=\"font-family:'Raleway',sans-serif;font-weight:700;color:#666;font-size:14px;text-align:left\">";
        ...
        body += "                        <span style=\"font-family:'Raleway',sans-serif;color:#666;font-size:15px;text-align:left; padding:0px 30px; display:block;\">";
        body += "                    In addition, please complete your Bios, which will be presented to the client when an opportunity fits you.";
        ...
        body += "                        <span style=\"font-family:'Raleway',sans-serif;font-weight:700;color:#666;font-size:18px;font-style: italic;\">";
        body += "                    Regards";
        body += "                    <\/span>";
        body += "                    <\/td>";
        body += "                <\/tr>";
